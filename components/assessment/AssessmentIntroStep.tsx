...
import { Box, Button, Card, Grid, Group, Image, Paper, Text, Title } from '@mantine/core';
        ...
        <Grid.Col span={{ base: 12, md: 4 }}>
          <Card shadow="sm" padding="lg" radius="md" withBorder h="100%">
            ...
            <Text size="sm" c="dimmed" lh={1.5}>
              The EU AI Act is a landmark regulation guiding the responsible development and use of
              artificial intelligence across Europe and beyond. Understanding your compliance
              obligations from the outset protects your organization, your users, and our society as
              AI systems become increasingly powerful and pervasive.
            </Text>
          </Card>
        </Grid.Col>
        <Grid.Col span={{ base: 12, md: 4 }}>
          <Card shadow="sm" padding="lg" radius="md" withBorder h="100%">
            ...
            <Text size="sm" c="dimmed" lh={1.5}>
              This wizard will guide you step-by-step through a preliminary assessment. By answering
              a few targeted questions, you'll discover which obligations may apply to your AI
              system and receive actionable advisory notes—customized based on your responses so
              far.
            </Text>
          </Card>
        </Grid.Col>
      ...
      <Box mb="xl">
        <Grid>
          ...
          <Grid.Col span={{ base: 12, md: 6 }}>
            ...
            <Text size="xs" c="dimmed" ml="2.25rem">
              General guidance only. Consult legal professionals or visit{' '}
              <a href="https://ittd.space" target="_blank" rel="noopener noreferrer">
                ittd.space
              </a>{' '}
              for specific advice.
            </Text>
